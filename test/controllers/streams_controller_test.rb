...
class StreamsControllerTest < ActionController::TestCase
  ...
  test "should create stream" do
    assert_difference('Stream.count') do
      post :create, stream: { form_id: @stream.form_id, name: @stream.name, student_id: @stream.student_id, user_id: @stream.user_id }
    end
  ...
  test "should update stream" do
    patch :update, id: @stream, stream: { form_id: @stream.form_id, name: @stream.name, student_id: @stream.student_id, user_id: @stream.user_id }
    assert_redirected_to stream_path(assigns(:stream))
  end
