...
class DisciplinesControllerTest < ActionController::TestCase
  ...
  test "should create discipline" do
    assert_difference('Discipline.count') do
      post :create, discipline: { level: @discipline.level, offense: @discipline.offense, punishment: @discipline.punishment, student_id: @discipline.student_id }
    end
  ...
  test "should update discipline" do
    patch :update, id: @discipline, discipline: { level: @discipline.level, offense: @discipline.offense, punishment: @discipline.punishment, student_id: @discipline.student_id }
    assert_redirected_to discipline_path(assigns(:discipline))
  end
